...
const easy = [
  ...
  window.onload = function(){
      // rum start game function when button is clicked 
  ...
  function startGame(){
        ...
        // SET LIVES  to 3 enable selecting numbers and tiles
        lives = 3
        disableSelect = false;
        ...
        if(id("theme-1").checked){
          qs("html").classList.remove("dark")
        }
        if(id("theme-2").checked){
          qs("html").classList.add("dark")
        }
      ...
      for(let i=0 ; i<81 ; i++){
          ...
          // if the tile is not supposed to be blank
            if(board.charAt(i) != '-'){
                ...
                //Add click event listen to tile
    ...
    if(selectedTile && selectedNum){
      ...
      if(checkCorrect(selectedTile)){
          // deselect the tile
            ...
            // if the num does not match the solution key 
      } else{
        ...
        setTimeout(function(){
            ...
            selectedTile.classList.remove("selected");
            selectedNum.classList.remove("selected")
            //clear the tiles text and clear the variables
